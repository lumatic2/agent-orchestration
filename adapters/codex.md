...
> Deployed to ~/.codex/AGENTS.md (global) and optionally symlinked per project.
...
SHARED_PRINCIPLES 의 "When Called as Worker Agent" 섹션 규칙을 그대로 적용한다. Scope 를 엄수하고, Done-criteria 를 검증한 뒤, 변경 파일·pass/fail 만 간결히 보고.
