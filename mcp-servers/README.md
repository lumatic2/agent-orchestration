...
```bash
claude mcp add codex-mcp -- node ~/projects/agent-orchestration/mcp-servers/codex-mcp/src/index.mjs
claude mcp add gemini-mcp -- node ~/projects/agent-orchestration/mcp-servers/gemini-mcp/src/index.mjs
```
...
```json
{
  "mcpServers": {
    "codex-mcp": {
      "command": "node",
      "args": ["~/projects/agent-orchestration/mcp-servers/codex-mcp/src/index.mjs"]
    },
    "gemini-mcp": {
      "command": "node",
      "args": ["~/projects/agent-orchestration/mcp-servers/gemini-mcp/src/index.mjs"]
    }
  }
}
```
