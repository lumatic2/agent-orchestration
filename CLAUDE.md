...
bash scripts/sync.sh             # adapter → ~/CLAUDE.md, ~/AGENTS.md, ~/.gemini/ 배포
...
새 파일·폴더를 추가하거나 옮길 때는 `docs/REPO_LAYOUT.md`를 먼저 확인. 폴더 역할·SoT 배포 매핑·라이프사이클·vault 규칙과의 관계가 명문화돼 있다.
