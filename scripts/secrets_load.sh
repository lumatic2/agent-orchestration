...
#   TELEGRAM_BOT_TOKEN_IT, TELEGRAM_CHAT_ID_IT,
#   TELEGRAM_CHAT_ID_CREATIVE, TELEGRAM_CHAT_ID_ACCOUNTING,
...
SECRETS=(
  ...
  TELEGRAM_BOT_TOKEN
  TELEGRAM_CHAT_ID
  TELEGRAM_BOT_TOKEN_IT
  TELEGRAM_CHAT_ID_IT
  TELEGRAM_CHAT_ID_CREATIVE
  TELEGRAM_CHAT_ID_ACCOUNTING
  SLACK_WEBHOOK_URL
